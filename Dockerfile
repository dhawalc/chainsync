# ---------------------- BUILDER STAGE ----------------------
    ...
    # Install additional dependencies needed for the build (including critters)
    RUN npm install --save clsx tailwind-merge @radix-ui/react-switch @radix-ui/react-select @radix-ui/react-label @radix-ui/react-slot @radix-ui/react-checkbox @radix-ui/react-dialog @radix-ui/react-dropdown-menu @radix-ui/react-popover @radix-ui/react-toast lucide-react recharts critters --legacy-peer-deps
    ...
    # In production, override these with secure values.
    ...
    # Enable mock data for Docker environment
